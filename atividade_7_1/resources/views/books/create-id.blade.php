...
<div class="container">
    ...
    <form action="{{ route('books.store.id') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control @error('cover_image') is-invalid @enderror" id="cover_image" name="cover_image" accept="image/*"> <!-- accept="image/*" para filtrar tipos de arquivo -->
            @error('cover_image')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
